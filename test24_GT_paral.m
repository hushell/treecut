function test24_GT_paral(dataset,img_s, img_t)
if nargin < 3
    dataset = 'train';
    img_range = [1 2];
end
...
eval_dir  = ['./output/grid_gt_eval/' dataset '/'];
    ...
    for s = 1:n_sub
        ...
        for j = 1:n_s
            for r = 1:n_r
                ...
                [~,segLabels] = inference_temp(gtTree, p, scal); % gtTree
